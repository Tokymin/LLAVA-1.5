...
deepspeed llava/train/train_mem.py \
    ...
    --version v1 \
    --data_path /mnt/share/HuggingfaceDatasets/liuhaotian/LLaVA-Instruct-150K/detail_23k.json \
    --image_folder /mnt/share/Datasets/LLAVA-1.5/playground/data/coco/train2017 \
    --vision_tower /mnt/share/HuggingfaceModels/openai/clip-vit-large-patch14-336 \
